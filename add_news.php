...
if(isset($_POST['submit'])){
  ...
  if(!empty($title) && !empty($url) ){
                ...
                $query="INSERT INTO `news`(`news_title`, `news_fied`, `news_url`) VALUES ('$title','$url','$url1')";
  ...
  <div class="col-sm-12">
    <div class="panel panel-login">
      <div class="panel-heading">
        <div class="row">
          <div class="col-xs-12">
            <a href="#" class="active" id="login-form-link">Add News</a>
          </div>
        </div>
        <hr>
      </div>
          ...
          <div class="col-lg-12">
            ...
            <thead class="thead-inverse">
              <tr style="background-color:orange;">
                <th><center><strong>News Title</strong></center></th>
            ...
            <tbody>
              ...
              <form action="add_news.php" method="post" role="form" style="display: block;" enctype="multipart/form-data">
			...
			<td style="width:300px;">
                    <div class="form-group">
                        <center><input type="text" id="url1" name="url1" style="width:180px;"></center>
                    </div>
                  </td>
