...
if(isset($_POST['submit'])){
  ...
  if(!empty($title) && !empty($name1) && !empty($name2)){

            $location1="download_img/$newtitle.png";
            $location2="download_file/$newtitle.pdf";

          if(move_uploaded_file($tmp_name1,$location1) && move_uploaded_file($tmp_name2,$location2)){
                $mysql_db='kwatt2iz_sparq';
                $connection = mysqli_connect('localhost', 'kwatt2iz_ravi', 'newone', $mysql_db);
                $size=round(filesize($location2)/(1000000));
                $query="INSERT INTO `downloads`(`Name`, `Image`, `File`, `Size`) VALUES ('$title','$location1','$location2','$size')";
  ...
  <div class="col-sm-12">
    <div class="panel panel-login">
      ...
      <div class="panel-heading">
        <div class="row">
          <div class="col-xs-12">
            <a href="#" class="active" id="login-form-link">Add Downloads</a>
          </div>
        </div>
        <hr>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <tbody>
              ...
              <form action="add_download.php" method="post" role="form" style="display: block;" enctype="multipart/form-data">
                ...
                <tr>
                  ...
                  <td style="width:300px;">
                    <div class="form-group">
                        <center><input type="file" name="file1"></center>
                    </div>
                  </td>

                  <td style="width:300px;">
                    <div class="form-group">
                        <center><input type="file" name="file2"></center>
                    </div>
                  </td>
