...
<div class="row">
              ...
              <ul class="nav nav-list">
                  <li><label style="margin-left:5%;"><strong>Students</strong> </label>
                      <ul class="nav nav-list tree" style="margin-left:10%;">
                          <li><a href="training.php" style="color:blue;">Basic</a></li>
    ...
    <div class="col-sm-9" >
        <div class="card" style="width:100%;border-color:black;border-width:20px;">
            <img class="card-img-top" src="training_img/basic.png" style="width:100%;height:350px;" alt="Card image cap">
            <div class="card-block" style="background-color:white;box-shadow: 7px 7px 7px #888888;">
              <h4 class="card-title">Basic Course</h4>
              <p class="card-text"  align="justify">This course is a 2 days training program which is designed with a objective of empowering
Plant for their House/College. Students will also get the practical know
develop solar products which will boost their Entrepreneur skills.</p>
<div class="panel-group" id="accordion" >
	<div class="panel panel-default">
        ...
        <div class="col-sm-8" >
          <h4 style="color:red;">Part 1 (Overview)</h4>
          <ul>
            <li align="justify">Solar Energy Scenario in India & Job Opportunities.</li>
            <li align="justify">Basics of Solar Photo Voltaic Technology (PV).</li>
          </ul>
          <h4 style="color:red;">Part 2 (Overview)</h4>
          <ul>
            <li align="justify">Basics of simulation tool</li>
            <li align="justify">Concepts of PV System Design</li>
            <li align="justify">Design a Solar Power Plant to light/power your own house/college.</li>
            <li align="justify">Understand the system design using simultation tool.</li>
            <li align="justify">Hands on experience to determine PV size, Inverter & Battery Capacity using tool.</li>
            <li align="justify">Estimation of monthly power generation and financial savings.</li>
          </ul>
        </div>
        <div class="col-sm-4" >
            <img class="card-img-top" src="icon/01.png" style="width:100%;height:200px;" alt="Card image cap">
        </div>
			</div>
		</div>
	</div>
	...
	<div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="col-sm-8" >
          <h4 style="color:red;">Part 3 (Overview)</h4>
          <h4 style="color:red;">Solar Operated Mobile Charger</h4>
          <ul>
            <li align="justify">Design and build your own Solar Mobile Charger.</li>
            <li align="justify">Get practical insight into basic and advanced features</li>
          </ul>
          <h4 style="color:red;" align="justify">Light seeking Robot</h4>
          <ul>
            <li align="justify">Design and build your own Vision 180.</li>
            <li align="justify">Get practical insight into basic and advanced features</li>
          </ul>
        </div>
        <div class="col-sm-4" >
            <img class="card-img-top" src="icon/14.png" style="width:100%;height:200px;" alt="Card image cap">
        </div>
			</div>
		</div>
	</div>
...
(Inclusive of 15% Service Tax)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
  ...
  <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul>
          <li>0.3W X 2 Solar Panels</li>
          <li>Mobile Charger Component Kit</li>
          <li>Content Book</li>
        </ul>
			</div>
		</div>
              ...
              <center><a href="registration_form.php" class="btn btn-readmore" >ENROLL</a></center>
              <br><br>
            </div>
        </div>
    </div>
