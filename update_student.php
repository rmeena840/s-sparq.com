...
$mysql_db='kwatt2iz_sparq';
  if(isset($_POST['submit']) && isset($_POST['year']) && isset($_POST['student']) && isset($_POST['trained'])){
    if(!empty($_POST['year']) || !empty($_POST['student']) || !empty($_POST['trained'])){
        ...
        $query="UPDATE `student_stastics` SET `years`='$year',`student_train`='$student',`entrepreneurs_train`='$trained' WHERE `S.No`=1";
  ...
  <div class="col-sm-12">
    <div class="panel panel-login">
      <div class="panel-heading">
        <div class="row">
          <div class="col-xs-12">
            <a href="#" class="active" id="login-form-link">Update Student Stastics</a>
          </div>
        </div>
        <hr>
      </div>
          ...
          <div class="col-lg-12">
            ...
            <thead class="thead-inverse">
              <tr style="background-color:orange;">
                <th><center><strong>Years</strong></center></th>
                <th><center>Student</center></th>
                <th><center>Entrepreneurs</center></th>
            ...
            <tbody>
              ...
              <form id="update_student" action="update_student.php" method="post" role="form" style="display: block;">
              ...
              <tr>
                ...
                <td>
                  <div class="form-group">
                    <input type="text" name="student" id="student" class="form-control" value="
                    <?php
                          $mysql_db='kwatt2iz_sparq';
                          $connection = mysqli_connect('localhost', 'kwatt2iz_ravi', 'newone', $mysql_db);
                ...
                <td>
                  <div class="form-group">
                    <input type="text" name="trained" id="trained" class="form-control" value="
                      <?php
                            $mysql_db='kwatt2iz_sparq';
                            $connection = mysqli_connect('localhost', 'kwatt2iz_ravi', 'newone', $mysql_db);
