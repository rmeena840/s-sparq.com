...
if(isset($_POST['submit'])){
  ...
  if(!empty($title) && !empty($url) && !empty($name)){

          if($extension=='png'){

            $location="affiliation_logo/$title.png";
          if(move_uploaded_file($tmp_name,$location)){
                $mysql_db='kwatt2iz_sparq';
                $connection = mysqli_connect('localhost', 'kwatt2iz_ravi', 'newone', $mysql_db);
                $query="INSERT INTO `affiliation`(`Title`, `URL`) VALUES ('$location','$url')";
  ...
  <div class="col-sm-12">
    <div class="panel panel-login">
      <div class="panel-heading">
        <div class="row">
          <div class="col-xs-12">
            <a href="#" class="active" id="login-form-link">Add Affiliation</a>
          </div>
        </div>
        <hr>
      </div>
          ...
          <div class="col-lg-12">
            ...
            <thead class="thead-inverse">
              <tr style="background-color:orange;">
                <th><center><strong>Image Title</strong></center></th>
            ...
            <tbody>
              ...
              <form action="add_affiliation.php" method="post" role="form" style="display: block;" enctype="multipart/form-data">
                ...
                <tr>
                  ...
                  <td style="width:300px;">
                    <div class="form-group">
                        <center><input type="text" id="url" name="url" style="width:180px;"></center>
                    </div>
                  </td>
...
<div class="container">
<div class="row">
<p>Please provide <strong>one word image title</strong></p>
</div>
</div>
