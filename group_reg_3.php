...
<head>
<head>
<title>SOLBIZZ DISCOUNT | S-SparQ</title>
<meta charset="UTF-8" />
...
<center style="margin-bottom:50px;"><b><font size="5" color="#0088cc" style="line-height:25px;">SOLBIZZ Registration</font></b></center>
...
<form action="<?php echo $action; ?>" method="POST" name="payuForm">
  <div class="form-group control-group">
      ...
      <h2 style="font-weight: 700; font-size: 22px; color: #08c;" align="center">Participant 1</h2><br>
                               <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>Name</label>
    <input type="text" class="form-control" name="firstname" id="firstname" value="<?php echo (empty($posted['firstname'])) ? '' : $posted['firstname']; ?>" placeholder="Enter your Name" required>
  </div>
  </div>
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    ...
    <input type="email" class="form-control" name="email" id="email" value="<?php echo (empty($posted['email'])) ? '' : $posted['email']; ?>" placeholder="Enter your email id" required>
                          ...
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>City</label>
    <input type="text" class="form-control" name="city" id="city" value="<?php echo (empty($posted['city'])) ? '' : $posted['city']; ?>" placeholder="Enter your city" required>
  </div>
  </div><br><br>
  
  <h2 style="font-weight: 700; font-size: 22px; color: #08c;" align="center">Participant 2</h2><br>
                               <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>Name</label>
    <input type="text" class="form-control" name="udf1" id="udf1" value="<?php echo (empty($posted['udf1'])) ? '' : $posted['udf1']; ?>" placeholder="Enter your Name" required>
  </div>
  </div>
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>Mobile</label>
    <input type="number" class="form-control" name="udf2" id="udf2" value="<?php echo (empty($posted['udf2'])) ? '' : $posted['udf2']; ?>" placeholder="Enter your Mobile no." required>
  </div>
  </div>
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>Email</label>
    <input type="email" class="form-control" name="udf3" id="udf3" value="<?php echo (empty($posted['udf3'])) ? '' : $posted['udf3']; ?>" placeholder="Enter your email id" required>
                          ...
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>City</label>
    <input type="text" class="form-control" name="udf4" id="udf4" value="<?php echo (empty($posted['udf4'])) ? '' : $posted['udf4']; ?>" placeholder="Enter your city" required>
  </div>
  </div><br><br>
  <h2 style="font-weight: 700; font-size: 22px; color: #08c;" align="center">Participant 3</h2><br>
                               <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>Name</label>
    <input type="text" class="form-control" name="udf5" id="udf5" value="<?php echo (empty($posted['udf5'])) ? '' : $posted['udf5']; ?>" placeholder="Enter your Name" required>
  </div>
  </div>
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>Mobile</label>
    <input type="number" class="form-control" name="udf6" id="udf6" value="<?php echo (empty($posted['udf6'])) ? '' : $posted['udf6']; ?>" placeholder="Enter your Mobile no." required>
  </div>
  </div>
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>Email</label>
    <input type="email" class="form-control" name="udf7" id="udf7" value="<?php echo (empty($posted['udf7'])) ? '' : $posted['udf7']; ?>" placeholder="Enter your email id" required>
                          ...
                          <div class="col-xs-6 control-group">
                            <div class="form-group floating-label-form-group controls">
    <label>City</label>
    <input type="text" class="form-control" name="udf8" id="udf8" value="<?php echo (empty($posted['udf8'])) ? '' : $posted['udf8']; ?>" placeholder="Enter your city" required>
  </div>
  </div>
