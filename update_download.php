...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
      <a href="add_download.php"><button type="button"  class="btn btn-info" style="font-size:20px;">Add</button></a>
    </div>
  </div>
</div>
  ...
  <div class="col-sm-12">
    <div class="panel panel-login">
      ...
      <div class="panel-heading">
        <div class="row">
          <div class="col-xs-12">
            <a href="#" class="active" id="login-form-link">Update Downloads</a>
          </div>
        </div>
        <hr>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <tbody>
              ...
              <form action="update_download.php" method="post" role="form" style="display: block;" enctype="multipart/form-data">
                ...
                <?php
                    ...
                    if($record=mysqli_query($connection,$query)){
                      while($get_record=mysqli_fetch_assoc($record)){
                        echo "<tr>";
                          ...
                          echo "<td><center><input type='text'  style='width:200px;' value ='".$get_record['Name']."' </center></td>";

                          echo "<td><center><img src='".$get_record['Image']."' height='82' width='122'></center></td>";

                          echo '<td><center> <a href="?delete='.$get_record["Name"].'" style="color:blue;"><u>Delete</u></a></center> </td>';
                    ...
                    $qry="SELECT * FROM `downloads` WHERE `Name`='".$_GET['delete']."'";
                    	if($record=mysqli_query($connection,$qry)){
                    		while($get_record=mysqli_fetch_assoc($record)){
                    			if(unlink($get_record['Image']) && unlink($get_record['File'])){
                    				$q1="DELETE FROM `downloads` WHERE `Name`='".$_GET['delete']."'";
