...
$email_subject = "$workshop_type | $productinfo";
...
$email_body2 = "Thank you for $productinfo registration. We will revert back to you soon.\n\n$email_name1\n$email_name2\n$email_signature";
...
<div class="alert alert-success" role="alert" style="font-size:16px; font-weight:600;" align="center"><?php echo "Thank You. Your order status is ". $status ?><br><?php echo "Your Transaction ID for this transaction is ".$txnid ?><br><?php echo "We have received a payment of Rs. " . $amount . ". You are now registered for $productinfo." ?></div>
</div>		
</div>	
<?php	
 }         
