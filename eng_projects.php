                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown" style="font-size:14px;color:#000000;"><strong>PROFESSIONALS</strong></a>
                    								<ul class="dropdown-menu">
                    									...
                    									<li><a href="solar_install1.php" style="font-size:14px;color:#000000;"><strong>SOLAR INSTALL</strong></a></li>
                    								</ul>
                							</li>
...
<div class="row">
              ...
              <ul class="nav nav-list">
                  <li><label style="margin-left:5%;"><strong>Students</strong> </label>
                      <ul class="nav nav-list tree" style="margin-left:10%;">
                          ...
                          <li><a href="eng_projects.php" style="color:blue;">Engineering Projects</a></li>
    ...
    <div class="col-sm-9" >
        <div class="card" style="width:100%;border-color:black;border-width:20px;">
            <img class="card-img-top" src="icon/17.png" style="width:100%;height:380px;" alt="Card image cap">
            <div class="card-block" style="background-color:white;box-shadow: 7px 7px 7px #888888;">
              <h4 class="card-title">Engineering Project</h4>
              <p class="card-text">kSPL mentors students who want to showcase their interests by implementing solar engineering techniques in their Mini Project and Major Project of their Engineering Curriculum. The kSPL team nurtures this interest of students by guiding them to build solar projects, come up with their ideas and provide them industrial support and make their fundamentals strong.</p>
              <p class="card-text">The Engineering projects can be done in a group of 3-4 students; students can select the project from the given list or can come up with their own ideas. </p>
...
<div class="panel-group" id="accordion" >
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Visit 1</a>
			</h4>
		</div>
        ...
        <div class="col-sm-7" >
        <ul>
          <li>The 1st visit will be for a period of 4 days</li>
          <li>Theory, block diagram explanation (project explanation), circuit explanation and software tutorials (if any) will be conducted during this visit.</li>
          <li>The required components will be handover to the students.</li>
          <li>Component mounting and soldering job will be assigned to the students, by the end of 1st visit.</li>
          <li>The students should complete the assigned work within a period of two weeks, from the end of 1st visit. The company won’t be responsible for incomplete soldering/circuit mounting by the students.</li>
        </ul>
      </div>
        <div class="col-sm-5" >
            <img class="card-img-top" src="icon/15.png" style="width:100%;height:200px;" alt="Card image cap">
        </div>
			</div>
		</div>
	</div>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Visit 2</a>
			</h4>
		</div>
        ...
        <div class="col-sm-7" >
        <ul>
          <li>The 2nd visit will be after 15 days from the end of 1st visit.</li>
          <li>This visit will comprise ONLY of circuit debugging.</li>
          <li>The output will be shown & completion signature will be taken from the students along with the faculty coordinator.</li>
        </ul>
      </div>
        <div class="col-sm-5" >
            <img class="card-img-top" src="icon/16.png" style="width:100%;height:200px;" alt="Card image cap">
        </div>
			</div>
		</div>
	</div>
  ...
  <div class="panel panel-default">
		...
		<div id="collapseThree" class="panel-collapse collapse">
			<div class="panel-body">
        <p>Solar SparQ is a social initiative of kWatt and we are looking for “Making Students Solar Smart”, and keeping note of student’s pockets, fees has been kept very nominal, affordable to students. Here is the fees structure tabulated below</p>
        <table class="table-striped table table-bordered">
        <thead class="thead-inverse">
          <tr style="background-color:black;">
            <th style="color:white;">#</th>
            <th style="color:white;">Training Program</th>
            <th style="color:white;">Duration Visits</th>
            <th style="color:white;">Fees (INR)/student
The fees is inclusive of 5% VAT</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>1</td>
            <td>Mini Engineering Project</td>
            <td><center>2 Visits</center></td>
            <td><center>4,500</center></td>
          </tr>
          <tr>
            <td>2</td>
            <td>
Major Engineering Project</td>
            <td><center>2 Visits</center></td>
            <td><center>5,000
</center></td>
          </tr>
